...
(function ($) {
  ...
  $.ajax({
    type: "GET",
    url: "http://localhost:8012/healthapp/dashboard/patient/data.php",
    data: formData,
    crossDomain: true,
    dataType: "json",
    encode: true,
  ...
  $.ajax({
    type: "GET",
    url:
      "http://localhost:8012/healthapp/dashboard/patient/geo_locate.php" + user,
    dataType: "json",
    encode: true,
  })
    .done(function (data) {
  ...
  var map_link =
    "https://maps.google.com/maps?q=hospitals%20in%20" +
    sessionStorage.getItem("geo_loc") +
  ...
  function updatePatient() {
    let url =
      "http://localhost:8012/healthapp/dashboard/patient/update.php/" + patID;
